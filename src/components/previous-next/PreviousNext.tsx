...
export default function PreviousNext({ className, previousUrl = "/", nextUrl = "/" }: PreviousNextProps) {
  ...
  return (
    <div className="flex justify-between w-full py-12">
      <h2 className={`font-antonio font-light text-back-case uppercase ${className}`}>
